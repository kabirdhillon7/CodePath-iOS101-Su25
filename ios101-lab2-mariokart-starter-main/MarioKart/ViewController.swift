...
//        let powerup = MushroomGenerator.maybeGenerateMushroomPowerup() // returns MushroomPowerup?
...
//        print(mysteryBox.mysteryEffect) // { effect = translate; }
        ...
        /*
         // Force cast mysteryEffect to a dictionary. If this cast fails, then the app crashes.
         let effectDictionary = mysteryBox.mysteryEffect as! [String: String]
         // Force cast the value of effectDictionary["effect"] to be a String (instead of String?).
         // If this cast fails, then the app crashes.
         let effect = effectDictionary["effect"]!
         if effect == "translate" {
